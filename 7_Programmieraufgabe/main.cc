...
int main()
{
	...
	cout << endl << "Vectors are equal: " << std::equal(result_exercise2.begin(), result_exercise2.end(), target.begin());
	cout << endl;
	...
	cout << endl << "Vectors are equal: " << std::equal(result_exercise3.begin(), result_exercise3.end(), target.begin());
	cout << endl;
