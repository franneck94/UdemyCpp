...
GameWindow::GameWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::GameWindow), LEN_X(5), LEN_Y(5)
{
    ui->setupUi(this);
}
...
void GameWindow::move_player(ConsoleInput &move, bool &finished)
{
    Position new_pos;
