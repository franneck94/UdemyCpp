...
int main()
{
    ...
    std::transform(vector_a.begin(), vector_a.end(), vector_b.begin(), vector_c.begin(), std::plus<int>());
    ...
    std::transform(vector_a.begin(), vector_a.end(), vector_c.begin(), increment);
